...
from .views import homepage, product_page, order_list, order_update_status, cart_page, checkout_page, check_order_status, content_page_list, content_page_edit, confirmation_page, sales_dashboard
